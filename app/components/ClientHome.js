    ...
    return (
        <div className="relative w-full h-[100dvh] overflow-hidden bg-black">
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center z-10 pointer-events-none">
                <div className={`transition-all duration-[1500ms] ease-in-out flex flex-col items-center md:mb-10 ${isExplored ? "-translate-y-[150vh] opacity-0" : "translate-y-0 opacity-100"}`}>
                    <div className="flex flex-col items-center mb-5 md:mb-5 pointer-events-auto">
                        ...
                        <h2 className="text-sm md:text-md text-white font-spartan font-bold text-center tracking-[0.2em] uppercase mt-[-0.5rem] md:mt-[-1.5rem] drop-shadow-xl z-10">Memoria Dome</h2>
                    </div>
                    ...
                    <blockquote className="max-w-xs md:max-w-sm text-center text-white/50 text-xs md:text-sm italic leading-relaxed mt-2 px-4">
                        ...
                        <span className="block not-italic text-white/30 text-[10px] md:text-xs mt-1">— Cassandra Clare</span>
                    </blockquote>
                </div>

                <div className={`absolute bottom-32 transition-all duration-[1500ms] ease-in-out delay-100 flex flex-col items-center gap-5 ${isExplored ? "translate-y-[150vh] opacity-0" : "translate-y-0 opacity-100"}`}>
                    <button
                    ...
                    <Link href="/about" className="pointer-events-auto text-white/40 hover:text-white/80 transition-colors text-xs md:text-sm font-spartan tracking-widest uppercase">
                        About
                    </Link>
                </div>
            </div>
