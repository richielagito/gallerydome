...
export default function DomeGallery({
    ...
    useEffect(() => {
      ...
      `;
            ...
            if (originalImg) {
                ...
                img.style.cssText = `width: 100%; height: 100%; object-fit: cover; border-radius: ${openedImageBorderRadius}; filter: ${grayscale ? "grayscale(1)" : "none"};`;
    ...
    const openItemFromElement = (el) => {
        ...
        const smallSrc = el.querySelector("img")?.currentSrc || fullSrc;
